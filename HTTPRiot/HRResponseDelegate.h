 ...
 * Keep in mind that progress can go back and forth in case of any redirects.
 *
 * @param progress A number between 0 and 1 describing how much data was fetched (a ration between amount of received data and content length, if known).
 */
- (void)restConnection:(NSURLConnection *)connection progress:(NSNumber*)progress object:(id)object;
